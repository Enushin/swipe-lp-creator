      ...
      tools: [
        {
          ...
          description:
            "Create GitHub Issue with automatic label assignment based on content",
          inputSchema: {
            type: "object",
            properties: {
              title: {
        ...
        },
        {
          ...
          description:
            "Create PR with agent-generated content and quality report",
          inputSchema: {
            type: "object",
            properties: {
              issueNumber: {
        ...
        },
        {
          ...
          description:
            "Get detailed review status including checks and approvals",
          inputSchema: {
            type: "object",
            properties: {
              prNumber: {
