  ...
  return {
    tools: [
      ...
      },
      {
        ...
        description:
          "既存プロジェクトにMiyabiをインストールします。.claude/、GitHub Actions、組織設計ラベル体系を追加します。",
        inputSchema: {
          type: "object",
          properties: {
            dryRun: {
      ...
      },
      {
        name: "miyabi__status",
        description:
          "プロジェクトの状態を確認します。GitHub Issues、Actions、Project V2の状態を表示します。",
        inputSchema: {
          type: "object",
          properties: {
            watch: {
      ...
      },
      {
        ...
        description:
          "Autonomous Agentを実行してGitHub Issueを自動処理します。CoordinatorAgent → CodeGenAgent → ReviewAgent → PRAgentの順で実行されます。",
        inputSchema: {
          type: "object",
          properties: {
            issueNumber: {
      ...
      },
      {
        name: "miyabi__auto",
        description:
          "Water Spider Agent（全自動モード）を起動します。GitHub Issueを自動的に検出・処理し続けます。",
        inputSchema: {
          type: "object",
          properties: {
            maxIssues: {
      ...
      },
      {
        name: "miyabi__todos",
        description:
          "コード内のTODOコメントを自動検出してGitHub Issueを作成します。",
        inputSchema: {
          type: "object",
          properties: {
            path: {
      ...
      },
      {
        ...
        description:
          "現在のプロジェクトのMiyabi/Claude Code統合状態を取得します（軽量・高速）",
        inputSchema: {
          type: "object",
          properties: {},
        },
